...
from vllm.core.scheduling_strategies import AudioPlayerStrategy, DefaultStrategy
...
class SchedulerSwappedInOutputs:
    ...
    swapped_out: List[SequenceGroup] = field(default_factory=list)
...
class Scheduler:
    ...
    def __init__(
        ...
        self.scheduler_strategy = scheduler_config.scheduler_strategy   # 调度策略
        strategy_map = {
    ...
    def _schedule_running(
        ...
        return self.strategy.schedule_running(self, budget, curr_loras, enable_chunking)
    ...
    def _schedule_swapped(
        ...
        return self.strategy.schedule_swapped(self, budget, curr_loras, enable_chunking)
    ...
    def _schedule_prefills(
        ...
        return self.strategy.schedule_prefills(self, budget, curr_loras, enable_chunking)

    def _schedule_default(self) -> SchedulerOutputs:
        return self.strategy.schedule_default(self)
